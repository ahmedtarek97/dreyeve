# -*- coding: utf-8 -*-
"""
Created on Sun Aug 16 16:43:40 2020
...
import PredictWindows
from AllinOne import get_focus_of_attention

class Window(QWidget):
    def __init__(self):
        super().__init__()
        
        self.setWindowTitle("Original Video")
    ...
    def ok_btn(self):
        self.sub = PredictWindows.Window()
        get_focus_of_attention(self.filename, 1500)
        self.sub.show()
    
    def play_video(self):
        self.sub.playBtn.animateClick()
